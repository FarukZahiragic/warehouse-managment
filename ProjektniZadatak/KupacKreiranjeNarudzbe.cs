...
namespace WindowsFormsApplication1
{
    public partial class KupacKreiranjeNarudzbe : Form
    {
        ...
        {
            string query = "SELECT artikal.artikal_id as 'ID artikla', naziv_artikla AS 'Naziv artikla', kolicina_stanje AS 'Dostupna količina', cijena AS 'Cijena', vrsta_artikla AS 'Vrsta artikla' FROM artikal, skladiste WHERE artikal.artikal_id=skladiste.artikal_id";
        ...
        {
            String query = "SELECT kolicina_stanje FROM skladiste WHERE artikal_id = '" +Convert.ToInt32(textBoxID.Text)+ "' ";
            MySqlConnection konekcija = new MySqlConnection(konekStr);
            konekcija.Open();
